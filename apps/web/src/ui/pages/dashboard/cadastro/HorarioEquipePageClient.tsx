...
interface HorarioEquipePageClientProps {
  initialData?: PaginatedResult<HorarioAberturaCatalogo>;
}

export default function HorarioEquipePageClient({
  initialData,
}: HorarioEquipePageClientProps) {
