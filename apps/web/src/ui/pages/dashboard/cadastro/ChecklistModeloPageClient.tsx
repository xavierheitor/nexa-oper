...
import type { Checklist, ChecklistTipoVeiculoRelacao, ChecklistTipoEquipeRelacao } from '@nexa-oper/db';
...
interface ChecklistModeloPageClientProps {
  checklistsInitialData?: PaginatedResult<Checklist>;
  tvVinculosInitialData?: PaginatedResult<ChecklistTipoVeiculoRelacao>;
  teVinculosInitialData?: PaginatedResult<ChecklistTipoEquipeRelacao>;
}

export default function ChecklistModeloPageClient({
  checklistsInitialData,
  tvVinculosInitialData,
  teVinculosInitialData,
}: ChecklistModeloPageClientProps) {
  ...
  const checklists = useEntityData<Checklist>({
    ...
    initialData: checklistsInitialData,
    initialParams: {
      page: 1,
      pageSize: 10,
      orderBy: 'id',
  ...
  const tvVinculos = useEntityData<ChecklistTipoVeiculoRelacao>({
    ...
    paginationEnabled: true,
    initialData: tvVinculosInitialData,
  ...
  const teVinculos = useEntityData<ChecklistTipoEquipeRelacao>({
    ...
    paginationEnabled: true,
    initialData: teVinculosInitialData,
