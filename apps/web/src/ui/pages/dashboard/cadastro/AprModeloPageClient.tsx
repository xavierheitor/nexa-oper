 ...
 */
interface AprModeloPageClientProps {
  aprsInitialData?: PaginatedResult<Apr>;
  taVinculosInitialData?: PaginatedResult<AprTipoAtividadeRelacao>;
}

export default function AprModeloPageClient({
  aprsInitialData,
  taVinculosInitialData,
}: AprModeloPageClientProps) {
  ...
  const taVinculos = useEntityData<AprTipoAtividadeRelacao>({
    ...
    paginationEnabled: true,
    initialData: taVinculosInitialData,
    initialParams: {
      page: 1,
      pageSize: 10,
      orderBy: 'id',
