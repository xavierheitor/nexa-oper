...
interface SupervisorPageClientProps {
  supervisoresInitialData?: PaginatedResult<Supervisor>;
  vinculosInitialData?: PaginatedResult<EquipeSupervisor>;
}

export default function SupervisorPageClient({
  supervisoresInitialData,
  vinculosInitialData,
  ...
  const supervisores = useEntityData<Supervisor>({
    ...
    initialData: supervisoresInitialData,
    initialParams: {
      page: 1,
      pageSize: 10,
      orderBy: 'id',
  ...
  const vinculos = useEntityData<EquipeSupervisor>({
    ...
    paginationEnabled: true,
    initialData: vinculosInitialData,
    initialParams: {
      page: 1,
      pageSize: 10,
      orderBy: 'id',
