...
export default function TipoAtividadePageClient({
  initialData,
}: TipoAtividadePageClientProps) {
  ...
  const columns = useTableColumnsWithActions<TipoAtividade>(
    [
      { title: 'ID', dataIndex: 'id', key: 'id', sorter: true, width: 80 },
      {
        ...
        key: 'nome',
        sorter: true,
        ...getTextFilter<TipoAtividade>('nome', 'nome'),
      },
      {
        title: 'Criado em',
        dataIndex: 'createdAt',
    ...
    ],
    {
      ...
      onDelete: (item) =>
        controller
          .exec(() => deleteTipoAtividade({ id: item.id }), 'Tipo excluido com sucesso!')
