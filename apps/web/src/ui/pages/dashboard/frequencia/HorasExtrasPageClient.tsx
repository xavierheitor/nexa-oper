...
interface HorasExtrasPageClientProps {
  initialData?: HoraExtraListResponse;
}

/**
 * Página de lista de horas extras
 */
export default function HorasExtrasPageClient({
  initialData,
}: HorasExtrasPageClientProps) {
  ...
  const { data, isLoading, mutate } = useSWR<HoraExtraListResponse>(
