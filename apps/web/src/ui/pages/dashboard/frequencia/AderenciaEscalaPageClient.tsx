...
interface AderenciaEscalaPageClientProps {
  initialBases: BaseOption[];
  initialTiposEquipe: TipoEquipeOption[];
}

export default function AderenciaEscalaPageClient({
  initialBases,
  initialTiposEquipe,
}: AderenciaEscalaPageClientProps) {
