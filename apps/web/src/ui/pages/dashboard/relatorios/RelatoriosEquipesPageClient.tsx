...
interface RelatoriosEquipesPageClientProps {
...
export default function RelatoriosEquipesPageClient({
  initialContratos = [],
  initialBases = [],
}: RelatoriosEquipesPageClientProps) {
  ...
  return (
    <div style={{ padding: '24px' }}>
      <Title level={2}>Relatorios - Equipes</Title>
