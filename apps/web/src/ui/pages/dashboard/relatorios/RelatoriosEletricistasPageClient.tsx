...
interface RelatoriosEletricistasPageClientProps {
...
export default function RelatoriosEletricistasPageClient({
  initialContratos = [],
  initialBases = [],
}: RelatoriosEletricistasPageClientProps) {
  ...
  return (
    <div style={{ padding: '24px' }}>
      <Title level={2}>Relatorios - Eletricistas</Title>
