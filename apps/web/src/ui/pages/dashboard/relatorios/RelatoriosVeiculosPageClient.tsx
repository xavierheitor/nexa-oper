...
interface RelatoriosVeiculosPageClientProps {
  initialContratos?: Contrato[];
  initialBases?: Base[];
}

export default function RelatoriosVeiculosPageClient({
  initialContratos = [],
  initialBases = [],
}: RelatoriosVeiculosPageClientProps) {
  ...
  return (
    <div style={{ padding: '24px' }}>
      <Title level={2}>Relatorios - Veiculos</Title>
