...
import {
  ...
  DadosGraficoHora,
  DadosGraficoBase,
} from '@/app/dashboard/turnos/types';
import { TurnosFilters } from '@/app/dashboard/turnos/components/TurnosFilters';
import { TurnosKPIs } from '@/app/dashboard/turnos/components/TurnosKPIs';
import { TurnosCharts } from '@/app/dashboard/turnos/components/TurnosCharts';
import { TurnosAbertosTable } from '@/app/dashboard/turnos/components/TurnosAbertosTable';
import { TurnosPrevistosStats } from '@/app/dashboard/turnos/components/TurnosPrevistosStats';
import { TurnosNaoAbertosTable } from '@/app/dashboard/turnos/components/TurnosNaoAbertosTable';
import { TurnosPrevistosTable } from '@/app/dashboard/turnos/components/TurnosPrevistosTable';
import { TurnosMatrixTable } from '@/app/dashboard/turnos/components/TurnosMatrixTable';
...
interface TurnosPageClientProps {
  initialBases: OptionItem[];
  initialTiposEquipe: OptionItem[];
}

export default function TurnosPageClient({
  initialBases,
  initialTiposEquipe,
  ...
  const basesData = initialBases;
  const tiposEquipeData = initialTiposEquipe;
  const loadingBases = false;
  const loadingTiposEquipe = false;
