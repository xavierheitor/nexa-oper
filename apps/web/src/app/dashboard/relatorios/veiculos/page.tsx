...
import RelatoriosVeiculosPageClient from '@/ui/pages/dashboard/relatorios/RelatoriosVeiculosPageClient';
import type { Base, Contrato } from '@nexa-oper/db';
import { redirect } from 'next/navigation';

export default async function RelatoriosVeiculosPage() {
