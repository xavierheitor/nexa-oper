...
import TurnosPorPeriodoPageClient from '@/ui/pages/dashboard/relatorios/TurnosPorPeriodoPageClient';
import type { Base, Contrato } from '@nexa-oper/db';
import { redirect } from 'next/navigation';

export default async function TurnosPorPeriodoPage() {
