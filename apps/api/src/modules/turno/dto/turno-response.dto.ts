/**
 * DTO para resposta de turno
 *
 * Este DTO define a estrutura de dados retornada
 * quando um turno é consultado no sistema.
 */

import { ApiProperty } from '@nestjs/swagger';

/**
 * DTO para eletricista na resposta
 */
export class EletricistaTurnoResponseDto {
  /**
   * ID do eletricista
   */
...
export class TurnoResponseDto {
  ...
  @ApiProperty({
    ...
    type: [EletricistaTurnoResponseDto],
  })
  eletricistas: EletricistaTurnoResponseDto[];
