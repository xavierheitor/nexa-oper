/**
 * Arquivo de índice para DTOs do módulo Eletricista
 */

export { CreateEletricistaDto } from './create-eletricista.dto';
export { UpdateEletricistaDto } from './update-eletricista.dto';
