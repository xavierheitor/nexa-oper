...
-- CreateTable
CREATE TABLE `PapelEquipe` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `nome` VARCHAR(255) NOT NULL,
    `ativo` BOOLEAN NOT NULL DEFAULT true,
    `exigeHabilitacao` BOOLEAN NOT NULL DEFAULT false,
    `prioridadeEscala` INTEGER NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `createdBy` VARCHAR(255) NOT NULL,
    `updatedAt` DATETIME(3) NULL,
    `updatedBy` VARCHAR(255) NULL,
...
-- CreateTable
CREATE TABLE `ComposicaoMinimaEquipe` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `equipeId` INTEGER NOT NULL,
    ...
    UNIQUE INDEX `ComposicaoMinimaEquipe_equipeId_papelId_key`(`equipeId`, `papelId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TipoEscala` (
    ...
    `minEletricistasPorTurno` INTEGER NULL,
    `ativo` BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE `TipoEscalaCicloPosicao` (
    ...
    `status` ENUM('TRABALHO', 'FOLGA') NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `createdBy` VARCHAR(255) NOT NULL,
    `updatedAt` DATETIME(3) NULL,
    `updatedBy` VARCHAR(255) NULL,
...
-- CreateTable
CREATE TABLE `ComposicaoMinimaTipoEscala` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `tipoEscalaId` INTEGER NOT NULL,
    `papelId` INTEGER NOT NULL,
    `quantidadeMinima` INTEGER NOT NULL,
    ...
    UNIQUE INDEX `ComposicaoMinimaTipoEscala_tipoEscalaId_papelId_key`(`tipoEscalaId`, `papelId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `EscalaEquipePeriodoComposicaoMinima` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    UNIQUE INDEX `EscalaEquipePeriodoComposicaoMinima_escalaEquipePeriodoId_pa_key`(`escalaEquipePeriodoId`, `papelId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `AtribuicaoEletricista` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `slotEscalaId` INTEGER NOT NULL,
    `eletricistaId` INTEGER NOT NULL,
    `papelId` INTEGER NOT NULL,
    `origem` ENUM('GERACAO', 'MANUAL', 'REMANEJAMENTO') NOT NULL DEFAULT 'GERACAO',
    `statusPlanejado` ENUM('ATIVO', 'REMOVIDO') NOT NULL DEFAULT 'ATIVO',
    `observacoes` VARCHAR(1000) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `createdBy` VARCHAR(255) NOT NULL,
    `updatedAt` DATETIME(3) NULL,
    ...
    INDEX `AtribuicaoEletricista_papelId_idx`(`papelId`),
    UNIQUE INDEX `AtribuicaoEletricista_slotEscalaId_eletricistaId_key`(`slotEscalaId`, `eletricistaId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `EventoCobertura` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `slotEscalaId` INTEGER NOT NULL,
    `eletricistaPlanejadoId` INTEGER NULL,
    ...
    INDEX `EventoCobertura_eletricistaPlanejadoId_idx`(`eletricistaPlanejadoId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `SlotEscala` (
    ...
    `estado` ENUM('TRABALHO', 'FOLGA', 'BLOQUEADO_CALENDARIO', 'EXCECAO') NOT NULL,
    ...
    UNIQUE INDEX `SlotEscala_escalaEquipePeriodoId_data_key`(`escalaEquipePeriodoId`, `data`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `ComposicaoMinimaEquipe` ADD CONSTRAINT `ComposicaoMinimaEquipe_equipeId_fkey` FOREIGN KEY (`equipeId`) REFERENCES `Equipe`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ComposicaoMinimaEquipe` ADD CONSTRAINT `ComposicaoMinimaEquipe_papelId_fkey` FOREIGN KEY (`papelId`) REFERENCES `PapelEquipe`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ComposicaoMinimaTipoEscala` ADD CONSTRAINT `ComposicaoMinimaTipoEscala_tipoEscalaId_fkey` FOREIGN KEY (`tipoEscalaId`) REFERENCES `TipoEscala`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ComposicaoMinimaTipoEscala` ADD CONSTRAINT `ComposicaoMinimaTipoEscala_papelId_fkey` FOREIGN KEY (`papelId`) REFERENCES `PapelEquipe`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `EscalaEquipePeriodoComposicaoMinima` ADD CONSTRAINT `EscalaEquipePeriodoComposicaoMinima_escalaEquipePeriodoId_fkey` FOREIGN KEY (`escalaEquipePeriodoId`) REFERENCES `EscalaEquipePeriodo`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `EscalaEquipePeriodoComposicaoMinima` ADD CONSTRAINT `EscalaEquipePeriodoComposicaoMinima_papelId_fkey` FOREIGN KEY (`papelId`) REFERENCES `PapelEquipe`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `AtribuicaoEletricista` ADD CONSTRAINT `AtribuicaoEletricista_slotEscalaId_fkey` FOREIGN KEY (`slotEscalaId`) REFERENCES `SlotEscala`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `AtribuicaoEletricista` ADD CONSTRAINT `AtribuicaoEletricista_eletricistaId_fkey` FOREIGN KEY (`eletricistaId`) REFERENCES `Eletricista`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `AtribuicaoEletricista` ADD CONSTRAINT `AtribuicaoEletricista_papelId_fkey` FOREIGN KEY (`papelId`) REFERENCES `PapelEquipe`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `EventoCobertura` ADD CONSTRAINT `EventoCobertura_eletricistaPlanejadoId_fkey` FOREIGN KEY (`eletricistaPlanejadoId`) REFERENCES `AtribuicaoEletricista`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
